...
import org.jboss.test.workshop.cdi.interceptors.support.BizBean;
...
public class StereotypeTestCase {
    ...
    public static Archive getDeployment() {
        ...
        return ShrinkWrap.create(JavaArchive.class)
                .addPackage(BizBean.class.getPackage())
                .addAsManifestResource(beansXml, "beans.xml");
    }

    @Test
    @OperateOnDeployment("stereotype")
    public void testStereotype(BizBean bb) throws Exception {
        bb.print("Testing stereotype.");
    }
